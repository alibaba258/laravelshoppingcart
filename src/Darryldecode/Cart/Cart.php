...
use diegonella\Cart\Exceptions\InvalidConditionException;
use diegonella\Cart\Exceptions\InvalidItemException;
use diegonella\Cart\Helpers\Helpers;
use diegonella\Cart\Validators\CartItemValidator;
use diegonella\Cart\Exceptions\UnknownModelException;

/**
 * Class Cart
 * @package diegonella\Cart
 */
class Cart
{
    ...
    public function addItemCondition($productId, $itemCondition)
    {
        if ($product = $this->get($productId)) {
            ...
            if ($itemCondition instanceof $conditionInstance) {
                ...
                // to avoid hitting this error "Indirect modification of overloaded element of diegonella\Cart\ItemCollection has no effect"
    ...
    public function condition($condition)
    {
        ...
        if (!$condition instanceof CartCondition) throw new InvalidConditionException('Argument 1 must be an instance of \'diegonella\Cart\CartCondition\'');
    ...
    /**
     * Por diegonella
     * Obtener todos los items que aplican cierta condición
     * 
     * @param String $type Tipo de condición a filtar
     * @return Array|null
     */
    public function getItemsConditionsByType(String $type)
    {
    ...
    /**
     * Borrar todas las condiciones de un $type especifico
     * No borra las condiciones de los items
     *
     * @param $type
     * @return $this
     */
    ...
    /**
     * Borra las condiciones del carrito,
     * pero no borra las condiciones de los items.
     * Para borrar las condiciones de un item: removeItemCondition($itemId, $conditionName)
     * Para borrar todas las condiciones de todos los items 
     *
     * @return void
     */
    ...
    /**
     * Obtener el subtotal con todas las condiciones por items aplicadas
     * @param bool $formatted
     * @return float
     */
    ...
    /**
     * Obtener el subtotal sin las condiciones de item tipo Tax
     * @param bool $formatted
     * @return float
     */
    public function getSubTotalWithoutTax($formatted = true)
    {
        ...
        $sum = $cart->sum(function (ItemCollection $item) {
            return $item->getPriceSumWithoutTax(false);
        });
